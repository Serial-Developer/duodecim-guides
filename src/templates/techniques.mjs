...
import { esc, paras, banner, pageShell, siteFooter } from './helpers.mjs';
...
${shared.attackPriority ? paras(shared.attackPriority.summary) + `<p class="sources-list"><a href="${esc(shared.attackPriority.source)}" rel="external noopener">${esc(shared.attackPriority.source)}</a></p>` : banner()}
...
<h2>Glossaire</h2>
${shared.glossaryNote ? paras(shared.glossaryNote.summary) + `<p class="sources-list"><a href="${esc(shared.glossaryNote.source)}" rel="external noopener">${esc(shared.glossaryNote.source)}</a></p>` : banner()}
</main>
${siteFooter()}`;
  return pageShell({
