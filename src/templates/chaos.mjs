...
import { esc, paras, pageShell, siteHeader, siteFooter } from './helpers.mjs';
...
<div class="banner info">Chaos est un boss des modes solo, non sélectionnable en versus : il n'a pas de guide compétitif. Sa forme jouable, <a href="feral-chaos.html">Feral Chaos</a>, a le sien. Page wiki : <a href="${esc(char.url)}" target="_blank" rel="external noopener">${esc(char.url)}</a>.</div>
</main>
${siteFooter()}`;
  return pageShell({
