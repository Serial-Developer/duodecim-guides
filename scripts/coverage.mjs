...
5. **Aerith sans portrait de Dissidia 012** : aucun \`ddff-port-aerith.png\` n'a jamais existé sur le CDN (vérifié via l'index CDX de la Wayback) ; sa page wiki ne contient aucune image, et l'index n'en conserve qu'une icône de 128×32. N'étant pas jouable, elle n'a pas de portrait d'écran de sélection. \`assets/portraits/aerith.png\` est donc un artwork officiel de *Final Fantasy VII* — les textes alternatifs et \`NOTICE.md\` le précisent.
